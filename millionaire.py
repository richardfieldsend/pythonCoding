...
testingMode = 0                 # set to 1 to show answers, set to
                                # zero for production.
fileOpen = open("results.txt", "rw+")
fileOpen.write("New game\n=== ====\n")
if testingMode == 1:
        fileOpen.write("The program is in testing mode. The answers are being displayed")
...
while noOfCorrectAnswers <= 14 and noOfWrongAnswers == 0:
        ...
        if guess == answer:
                ...
                fileOpen.write("%s and %s = %s. User answer is: %s\n" % (firstNumber, secondNumber, answer, guess))
        ...
        # logic is incomplete. Sorry!
                ...
                if retry != answer and secondChance < 3:
                        ...
                        noOfWrongAnswers = 0
                        noOfCorrectAnswers = noOfCorrectAnswers + 1
                fileOpen.write("%s * %s = %s. User answer is: %s\n" % (firstNumber, secondNumber, answer, guess))
                if noOfCorrectAnswers == 1:
                        print "\nYou have made 100"
                elif noOfCorrectAnswers ==2:
                        print "\nYou have made 200"
...
fileOpen.write("\nFinal results.\nNumber of questions right: %s" % noOfCorrectAnswers)
fileOpen.close()
